...
import com.projet.miniprojet.androidVox.exoplayer.toSong
import com.projet.miniprojet.androidVox.models.Song
import com.projet.miniprojet.androidVox.other.Status
import com.projet.miniprojet.androidVox.other.Status.SUCCESS
import com.projet.miniprojet.androidVox.ui.viewModel.MainViewModel
import com.projet.miniprojet.androidVox.ui.viewModel.SongViewModel
...
class SongFragment : Fragment(R.layout.fragment_song) {
    ...
    private fun updateTitleAndSongImage(song: Song) {
        val title = "${song.title} - ${song.description}"
