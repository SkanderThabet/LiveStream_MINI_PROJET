package com.projet.miniprojet.androidVox.activities.LiveStreamChatInteraction.feature.event.detail
...
import com.projet.miniprojet.androidVox.databinding.ActivityEventDetailsBinding
    ...
    private fun initializePlayer() {
        player = SimpleExoPlayer.Builder(this)
            ...
            .also { exoPlayer ->
                ...
                val videoUri = Uri.parse("rtmp://192.168.42.68/live/test")
                val videoSource = ProgressiveMediaSource.Factory(RtmpDataSourceFactory())
                    .createMediaSource(MediaItem.fromUri(Uri.parse("rtmp://192.168.42.68/live/test")))
