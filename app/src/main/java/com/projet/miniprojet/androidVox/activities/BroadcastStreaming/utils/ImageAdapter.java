...
package com.projet.miniprojet.androidVox.activities.BroadcastStreaming.utils;
...
public class ImageAdapter extends BaseAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      button.setBackgroundColor(ResourcesCompat.getColor(resources, R.color.indigo_A700, null));
